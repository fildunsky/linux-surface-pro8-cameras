...
static const struct ipu_sensor_config ipu_supported_sensors[] = {
	 ...
	 * ACPI-идентификатор SMO55F0; сенсор опознан по виндовому драйверу
	 * vd55g0.inf ("installing VD55G0 camera sensor", ACPI\SMO55F0), а
	 * идентификатор модели 0x53354730 подтверждён в бинарнике vd55g0.sys.
	 * Одна линия и 600 МГц — как в примере биндинга st,vd55g1 (тот же
	 * регистровый набор); это верхняя граница, которую допускает драйвер
	 * (VD55G1_MIPI_RATE_MAX = 1200 Мбит/с, а линк вдвое меньше).
	 */
